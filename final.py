...
drivers = pd.read_csv('D:/MTU/DATASETS/drivers.csv')
circuits = pd.read_csv('D:/MTU/DATASETS/circuits.csv',index_col=0, na_values=r'\N')
constructorResults = pd.read_csv('D:/MTU/DATASETS/constructor_results.csv',index_col=0, na_values=r'\N')
constructors = pd.read_csv('D:/MTU/DATASETS/constructors.csv',index_col=0, na_values=r'\N')
constructorStandings = pd.read_csv('D:/MTU/DATASETS/constructor_standings.csv',index_col=0, na_values=r'\N')
driverStandings = pd.read_csv('D:/MTU/DATASETS/driver_standings.csv',index_col=0, na_values=r'\N')
lapTime = pd.read_csv('D:/MTU/DATASETS/lap_times.csv')
pitStops = pd.read_csv('D:/MTU/DATASETS/pit_stops.csv')
qualifying = pd.read_csv('D:/MTU/DATASETS/qualifying.csv',index_col=0, na_values=r'\N')
races = pd.read_csv('D:/MTU/DATASETS/races.csv',index_col=0, na_values=r'\N')
results = pd.read_csv('D:/MTU/DATASETS/results.csv',index_col=0, na_values=r'\N')
seasons = pd.read_csv('D:/MTU/DATASETS/seasons.csv',index_col=0, na_values=r'\N')
status = pd.read_csv('D:/MTU/DATASETS/status.csv',index_col=0, na_values=r'\N')
